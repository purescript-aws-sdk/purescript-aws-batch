...
cancelJob = Request.request service method  where
    service = Request.ServiceName "Batch"
...
createComputeEnvironment = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "createComputeEnvironment"
...
createJobQueue = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "createJobQueue"
...
deleteComputeEnvironment = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "deleteComputeEnvironment"
...
deleteJobQueue = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "deleteJobQueue"
...
deregisterJobDefinition = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "deregisterJobDefinition"
...
describeComputeEnvironments = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "describeComputeEnvironments"
...
describeJobDefinitions = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "describeJobDefinitions"


-- | <p>Describes one or more of your job queues.</p>
describeJobQueues :: forall eff. DescribeJobQueuesRequest -> Aff (exception :: EXCEPTION | eff) DescribeJobQueuesResponse
describeJobQueues = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "describeJobQueues"
...
describeJobs = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "describeJobs"
...
registerJobDefinition = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "registerJobDefinition"
...
submitJob = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "submitJob"
...
terminateJob = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "terminateJob"
...
updateComputeEnvironment = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "updateComputeEnvironment"


-- | <p>Updates a job queue.</p>
updateJobQueue :: forall eff. UpdateJobQueueRequest -> Aff (exception :: EXCEPTION | eff) UpdateJobQueueResponse
updateJobQueue = Request.request service method  where
    service = Request.ServiceName "Batch"
    method = Request.MethodName "updateJobQueue"
